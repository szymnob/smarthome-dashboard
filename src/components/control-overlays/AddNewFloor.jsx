...
export default function AddNewFloor({onClose}) {
    ...
    const handleFloorNumberChange = (e) => {
        ...
        if(existingFloors.includes(value)){
            ...
            setError("Floor number out of range");
        ...
        <>
            <div className="m-5">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <Input id="floorNumber" label="Floor number:" type="number" value={floorNumber} onChange={handleFloorNumberChange}/>
                    <Input id="floorName" label="Floor name:" type="text" value={floorName} onChange={(e) => setFloorName(e.target.value)}/>
